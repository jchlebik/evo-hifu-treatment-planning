function test_pass = kWaveDiffusion_compare_3D_heterog_with_exact(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
s1 = smooth(kgrid, makeBall(Nx, Ny, Nz, Nx/2, Ny/4, Nz/2, 3));
s2 = smooth(kgrid, makeBall(Nx, Ny, Nz, Nx/2, 3*Ny/4, Nz/2, 3));
