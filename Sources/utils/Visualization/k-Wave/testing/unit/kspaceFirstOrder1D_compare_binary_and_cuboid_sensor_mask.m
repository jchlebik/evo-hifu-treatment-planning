function test_pass = kspaceFirstOrder1D_compare_binary_and_cuboid_sensor_mask(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
% run the simulation
sensor_data_cuboids = kspaceFirstOrder1D(kgrid, medium, source, sensor, input_args{:});
...
cuboid_index = 1;
sensor.mask(cuboid_corners(1, cuboid_index):cuboid_corners(2, cuboid_index)) = 1;

% run the simulation
sensor_data_comp1 = kspaceFirstOrder1D(kgrid, medium, source, sensor, input_args{:});
...
L_inf_max = max([L_inf_p, L_inf_p_max, L_inf_p_min, L_inf_p_rms,... 
    ...
    L_inf_p_max_all, L_inf_ux_max_all, ...
    L_inf_p_min_all, L_inf_ux_min_all, ...
    L_inf_p_final, L_inf_ux_final]);
...
% run the simulation
sensor_data_comp2 = kspaceFirstOrder1D(kgrid, medium, source, sensor, input_args{:});
