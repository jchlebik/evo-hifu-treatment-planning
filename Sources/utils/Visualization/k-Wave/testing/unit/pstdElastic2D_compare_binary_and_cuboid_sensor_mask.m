function test_pass = pstdElastic2D_compare_binary_and_cuboid_sensor_mask(plot_comparisons, plot_simulations)
% DESCRIPTION:
...
% run the simulation
sensor_data_cuboids = pstdElastic2D(kgrid, medium, source, sensor, input_args{:});
...
% run the simulation
sensor_data_comp1 = pstdElastic2D(kgrid, medium, source, sensor, input_args{:});
...
% run the simulation
sensor_data_comp2 = pstdElastic2D(kgrid, medium, source, sensor, input_args{:});
