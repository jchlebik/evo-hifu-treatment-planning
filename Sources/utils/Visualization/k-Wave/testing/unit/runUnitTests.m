...
% get unit testing directory
exam_dir = getkWavePath('testing/unit');

% move there
cd(exam_dir);

% clear previous unit test results
temp_var_filename = [tempdir 'runUnitTests_TEMP_VARS.mat'];
...
for filename_index = 1:(length(filenames) - 1)
