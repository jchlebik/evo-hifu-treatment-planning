 ...
 */
#pragma once
#ifndef KEVOOPT_FITNESSFUNCTIONS_HIFUSCORE_DATAMODELS_DISCRETEMAP_HPP_INCLUDE
#define KEVOOPT_FITNESSFUNCTIONS_HIFUSCORE_DATAMODELS_DISCRETEMAP_HPP_INCLUDE
